...
quant & backtesting engine, the execution & compliance layer, the multi-seat
desk, and your provenance store. Use them to gather real data and compute real
numbers before you answer.
